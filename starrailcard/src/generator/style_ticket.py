...
class Create:
    ...
    async def create_relict(self,relict):
        ...
        d.text((19, 1), self.lang.score, font=font_14, fill = (255,255,255,255))
        d.text((67, 1), str(score["count"]), font=font_14, fill = score["rank"]["color"])
        
        d.text((136, 1), self.lang.rank, font=font_14, fill = (255,255,255,255))
        d.text((178, 1), str(score["rank"]["name"]), font=font_14, fill = score["rank"]["color"])
        
        d.text((239, 1), self.lang.eff_stat, font=font_14, fill = (255,255,255,255))
